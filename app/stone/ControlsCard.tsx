    ...
    <Card>
      ...
      <CardContent className="flex flex-col gap-3">
        {!mediaStreamActive ? (
          ...
          <Button onClick={onStopScreenShare} variant="destructive" className="w-full">
            Stop Screen Share
          </Button>
        )}
        <div className="flex items-center space-x-2 mt-2">
          ...
          />
          <Label htmlFor="show-debug-info" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
            Show Debug Info
          </Label>
        </div>
      </CardContent>
